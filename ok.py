...
try:
    ...
    # mujer
    query19=articulos(imagen="blusa1.webp",nombre="ok1",precio=10.22,iva=0.12,descripcion="xxx",stock=5,cat_id=1) 
    query20=articulos(imagen="blusa2.webp",nombre="ok2",precio=20.22,iva=0.12,descripcion="xxx",stock=5,cat_id=1)
    query21=articulos(imagen="chaqueta1.webp",nombre="ok3",precio=30.22,iva=0.12,descripcion="xxx",stock=5,cat_id=1)
    query22=articulos(imagen="chaqueta-casual1.jpg",nombre="ok4",precio=40.22,iva=0.12,descripcion="xxx",stock=5,cat_id=1)

    query23=articulos(imagen="falda1.jpg",nombre="ok5",precio=10.22,iva=0.12,descripcion="xxx",stock=5,cat_id=2) 
    query24=articulos(imagen="falda2.jpg",nombre="ok6",precio=20.22,iva=0.12,descripcion="xxx",stock=5,cat_id=2)
    query25=articulos(imagen="vestido1.jpg",nombre="ok7",precio=30.22,iva=0.12,descripcion="xxx",stock=5,cat_id=2)
    query26=articulos(imagen="vestido2.jpg",nombre="ok8",precio=40.22,iva=0.12,descripcion="xxx",stock=5,cat_id=2)
    ...
    query52=articulos(imagen="zcamisa-niño2.webp",nombre="ok34",precio=20.22,iva=0.12,descripcion="xxx",stock=2,cat_id=9)
    query53=articulos(imagen="zcamisa-niño3.jpg",nombre="ok35",precio=30.22,iva=0.12,descripcion="xxx",stock=3,cat_id=9)
    query54=articulos(imagen="zcamisa-niño5.jpg",nombre="ok36",precio=40.22,iva=0.12,descripcion="xxx",stock=4,cat_id=9)

    query55=articulos(imagen="zpantalon-niño1.webp",nombre="ok37",precio=10.22,iva=0.12,descripcion="xxx",stock=5,cat_id=10) 
    query56=articulos(imagen="zpantalon-niño3.jpg",nombre="ok38",precio=20.22,iva=0.12,descripcion="xxx",stock=6,cat_id=10)
    query57=articulos(imagen="zpantalon-niño2.jpg",nombre="ok39",precio=30.22,iva=0.12,descripcion="xxx",stock=7,cat_id=10)
    query58=articulos(imagen="zpantalon-niño3.jpg",nombre="ok40",precio=40.22,iva=0.12,descripcion="xxx",stock=8,cat_id=10)
